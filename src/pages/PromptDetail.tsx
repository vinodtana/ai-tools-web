...
import { fetchAIToolDetails , fetchAIPromots} from "../store/features/contents/contentsSlice";
...
const PromptDetail = () => {
  const { id } = useParams();
   ...
   const {  cDetails, aiCategories, aIPromots } = useAppSelector(
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <Badge variant="secondary" className={`
                      ${cDetails.difficulty === 'Beginner' ? 'bg-green-100 text-green-700 border-green-200' :
                        cDetails.difficulty === 'Intermediate' ? 'bg-yellow-100 text-yellow-700 border-yellow-200' :
                ...
                {cDetails?.examples?.map((example, index) => (
                  <div key={index} className="border rounded-lg p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <p className="text-sm font-medium text-muted-foreground mb-2">Output Preview:</p>
