                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap items-center gap-4 mb-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-semibold">{cDetails.rating}</span>
                          </div>
                        ...
                        <div className="flex flex-wrap gap-2 mb-6">
                          {cDetails?.category_names?.map((category, index) => (
                ...
                <Tabs defaultValue="overview" className="w-full">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {cDetails?.features?.map((feature, index) => (
                           <div key={index} className="flex items-center gap-3 p-4 rounded-lg border hover:border-primary transition-colors">
                  ...
                  <TabsContent value="pros-cons" className="space-y-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                      <div>
                        ...
                        <div className="space-y-3">
                         ...
                         { pro&& (
                            ...
                            <div key={index} className="flex items-start gap-3 p-3 rounded-lg border border-green-200 hover:border-green-400 transition-colors dark:border-green-800 dark:hover:border-green-600">
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-4 text-orange-600">Cons</h3>
                        <div className="space-y-3">
                          {cDetails?.toolCons?.map((con, index) => (
                            <>
                         { con&& (
                            <div key={index} className="flex items-start gap-3 p-3 rounded-lg border border-orange-200 hover:border-orange-400 transition-colors dark:border-orange-800 dark:hover:border-orange-600">
                  ...
                  <TabsContent value="media" className="space-y-6">
                    <div>
                      <h3 className="text-2xl font-bold mb-4">Screenshots & Media</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {cDetails?.images?.map((image, index) => (
                        <Card key={index} className="group hover:border-primary hover:scale-105 transition-all duration-300">
                          <CardContent className="p-4">
                              <div className="aspect-video bg-muted rounded-lg mb-3 flex items-center justify-center">
                                <img src={image} alt={`Screenshot ${index + 1}`} className="object-cover w-full h-full rounded-lg" /> 
                              </div>
                              <h4 className="font-medium">Screenshot {index + 1}</h4>
                              <p className="text-sm text-muted-foreground">Tool Interface</p>
                            </CardContent>
                          </Card>
                        ))}
                      </div>
        ...
        <div className="mt-12">
          <Card className="hover:border-primary hover:shadow-2xl hover:scale-105 transition-all duration-500">
            <CardHeader>
              ...
              <p className="text-muted-foreground">Discover other AI tools in the same category</p>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="flex items-center justify-center pt-4 border-t border-primary/10 mb-4">
                        <div className="text-center">
                          <span className="font-medium text-primary text-sm">{similarTool.price}</span>
                        </div>
                      </div>
