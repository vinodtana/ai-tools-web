...
const Index = () => {
  ...
  useEffect(() => {
    ...
    const jsonObj = { page: 1, limit: 8 };
    dispatch(fetchAITools(jsonObj));
    dispatch(fetchAITopTools({ page: 1, limit: 8 }));
    if (user?.id) {
      dispatch(
        getAllContentLikesByUserId({
          user_id: user?.id,
  ...
  const sections = [
    {
      ...
      extendedDescription:
        "From content creation to data analysis, find the perfect AI tool for your workflow. Our curated collection includes free and premium options across 50+ categories.",
      features: [
        "3000+ Tools",
        "Free & Premium",
        "50+ Categories",
    ...
    },
    {
      ...
      extendedDescription:
        "Professional-grade prompts tested and optimized for ChatGPT, Claude, and other AI models. Save hours with our productivity-focused prompt library.",
      features: [
        "20+ Prompts",
        "Copy & Use",
        "Multi-Model",
    ...
    },
    {
      ...
      extendedDescription:
        "Expert analysis, tutorials, and deep dives into AI technology. Stay informed with comprehensive articles written by industry professionals.",
      features: [
        "30+ Articles",
        "Expert Authors",
        "Weekly Updates",
    ...
    },
    {
      ...
      extendedDescription:
        "Breaking news, product launches, and industry updates from the fast-paced world of artificial intelligence. Never miss important developments.",
      features: [
        "Daily Updates",
        "Breaking News",
        "Industry Insights",
    ...
    },
    {
      ...
      extendedDescription:
        "Connect with thought leaders, researchers, and innovators shaping the future of AI. Discover their insights and latest projects.",
      features: [
        "10+ Influencers",
        "Industry Leaders",
        "Social Links",
    ...
    },
    {
      ...
      extendedDescription:
        "Browse AI tools organized by specific use cases and industries. Find exactly what you need with our detailed categorization system.",
      features: [
        "40+ Categories",
        "Use Case Focus",
        "Industry Specific",
    ...
    <Layout>
      ...
      <section className="relative overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="absolute inset-0 purple-light-gradient">
          ...
          <div
            className="absolute top-32 right-10 w-80 h-80 bg-primary/12 rounded-full blur-3xl animate-float opacity-80"
            style={{ animationDelay: "1.5s" }}
          ></div>
          <div
            className="absolute bottom-32 left-1/4 w-72 h-72 bg-primary/6 rounded-full blur-3xl animate-float opacity-70"
            style={{ animationDelay: "3s" }}
          ></div>
          <div
            className="absolute top-1/2 right-1/3 w-64 h-64 bg-primary/10 rounded-full blur-3xl animate-float opacity-50"
            style={{ animationDelay: "4.5s" }}
          ></div>
          <div
            className="absolute bottom-10 right-20 w-88 h-88 bg-primary/5 rounded-full blur-3xl animate-float opacity-60"
          ...
          ></div>
          <div
            className="absolute top-3/4 right-1/4 w-1 h-1 bg-primary/60 rounded-full animate-float"
            style={{ animationDelay: "3s" }}
          ></div>
          <div
            className="absolute top-1/2 left-3/4 w-3 h-3 bg-primary/30 rounded-full animate-float"
        ...
        <div className="relative container mx-auto px-4 py-6 z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold mb-4 leading-tight">
              ...
              >
                <span className="text-foreground hover:text-primary transition-colors duration-500">
                  {" "}
                  <span className="ai-name-top-primary">AI</span> Tools
                </span>
              </div>
            </h1>
            ...
            >
              <p className="text-xl md:text-2xl text-muted-foreground mb-4 max-w-3xl mx-auto leading-relaxed">
                Your ultimate destination for AI tools, news, articles, and
                insights. Stay ahead with the best AI resources curated for
                professionals.
              </p>
              <p className="text-lg text-muted-foreground/80 mb-6 max-w-2xl mx-auto">
                Join thousands of innovators who trust our platform to discover
            ...
            <div
              className="flex flex-col sm:flex-row gap-6 justify-center animate-scale-bounce"
              style={{ animationDelay: "0.8s" }}
            >
              <Link to="/ai-tools">
                <Button
                  size="lg"
                  className="group relative primary-gradient text-lg px-10 py-4 soft-shadow hover:scale-110 transition-all duration-300 overflow-hidden"
                >
              ...
              <Link to="/ai-news">
                <Button
                  size="lg"
                  variant="outline"
                  className="group text-lg px-10 py-4 bg-white/60 backdrop-blur-sm border-primary/30 hover:bg-white/80 hover:scale-110 transition-all duration-300 hover:border-primary/60 hover:shadow-xl"
                >
      ...
      <section className="py-20 bg-muted/30 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div
            className="absolute top-32 right-10 w-64 h-64 bg-primary/12 rounded-full blur-3xl animate-float"
            style={{ animationDelay: "1.5s" }}
          ></div>
          <div
            className="absolute bottom-32 left-1/4 w-80 h-80 bg-primary/6 rounded-full blur-3xl animate-float"
            style={{ animationDelay: "3s" }}
          ></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Discover comprehensive AI resources organized for your needs with
          ...
          <div className="space-y-16 max-w-7xl mx-auto">
            {sections.map((section, index) => (
              <div
                key={section.title}
                className="animate-slide-up border border-primary/20 rounded-2xl p-8 bg-white/50 backdrop-blur-sm hover:border-primary/40 hover:shadow-xl transition-all duration-300"
                  ...
                  <div className="flex-1 space-y-6">
                    ...
                    <div className="pt-4">
                      <Link to={section.href}>
                        <Button
                          size="lg"
                          className="group primary-gradient text-white px-8 py-4 hover:scale-105 transition-all duration-300"
                        >
                      ...
                      <p className="text-muted-foreground text-sm mt-3">
                        Explore {section.count} curated{" "}
                        {section.title.toLowerCase()} in our collection
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              AI Market Trends & Analytics
            </h2>
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto leading-relaxed">
              Stay ahead of the curve with real-time AI industry data, market
              trends, and comprehensive analytics from leading research firms.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {[
              ...
              },
              {
                ...
                title: "Investment",
                value: "$50B+",
                subtitle: "In AI Startups",
                color: "from-orange-500 to-red-500",
              },
            ].map((stat, index) => (
              <Card
                key={index}
                className="group hover:bg-transparent hover:border-primary hover:scale-105 transition-all duration-500 text-center animate-slide-up"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <CardContent className="p-6">
                  <div className="mb-4">
                    <div
                      className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-r ${stat.color} shadow-lg group-hover:scale-110 transition-transform duration-300`}
                    >
          ...
          <div className="text-center">
            <Button
              variant="outline"
              className="group bg-white/60 backdrop-blur-sm border-primary/30 hover:bg-primary hover:text-white hover:scale-105 transition-all duration-300"
            >
      ...
      <section className="py-20 bg-muted/20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto leading-relaxed">
              Discover how leading companies are leveraging AI tools to drive
              innovation, increase productivity, and achieve remarkable results.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Automated content creation and customer service using ChatGPT and Claude, reducing response time from hours to minutes.",
              ...
              },
              {
                ...
                description:
                  "Revolutionary design workflow using Midjourney and AI tools, creating stunning visuals in minutes instead of days.",
              ...
              },
              {
                ...
                description:
                  "Streamlined data analysis and reporting using advanced AI analytics tools, eliminating manual processing.",
              ...
              <Card
                key={index}
                className="group hover:bg-transparent hover:border-primary hover:scale-105 transition-all duration-500 animate-slide-up overflow-hidden"
      ...
      <section className="py-20 bg-gradient-to-br from-muted/30 to-white relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full">
          ...
          <div
            className="absolute bottom-10 left-10 w-32 h-32 bg-primary/8 rounded-full blur-2xl animate-float"
            style={{ animationDelay: "2s" }}
          ></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Why We Need AI Tools Today
            </h2>
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto leading-relaxed">
              In today's fast-paced digital world, AI tools have become
              essential for staying competitive, efficient, and innovative
            ...
            {[
              {
                ...
                description:
                  "Automate repetitive tasks and increase productivity by 10x",
              ...
              },
              {
                ...
                description:
                  "Generate innovative ideas and creative solutions instantly",
              ...
              },
              {
                ...
                description:
                  "Reduce human error and streamline complex processes",
              ...
              <Card
                key={index}
                className="group hover:border-primary hover:scale-105 transition-all duration-500 text-center animate-slide-up"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <CardContent className="p-6">
                  <div className="mb-4">
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto leading-relaxed">
              Experience the game-changing benefits that AI tools bring to
              modern businesses and professionals worldwide.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Complete tasks in minutes that previously took hours. AI handles repetitive work while you focus on strategy and creativity.",
                benefits: [
                  "Save 5+ hours daily",
                  "Automate workflows",
              ...
              },
              {
                ...
                description:
                  "Make data-driven decisions with AI-powered insights and analytics that reveal hidden patterns and opportunities.",
                benefits: [
                  "Real-time analytics",
                  "Predictive insights",
                  "Risk assessment",
              ...
              },
              {
                ...
                description:
                  "Deliver personalized experiences and instant support that delights customers and builds lasting relationships.",
                benefits: [
                  "24/7 availability",
                  "Personalization",
                  "Instant responses",
              ...
              <Card
                key={index}
                className="group hover:border-primary hover:scale-105 transition-all duration-500 animate-slide-up overflow-hidden"
                style={{ animationDelay: `${index * 0.15}s` }}
              >
                <CardContent className="p-8">
                  <div className="mb-6">
                    <div
                      className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-r ${benefit.color} shadow-lg group-hover:scale-110 transition-transform duration-300`}
                    >
      ...
      <section className="py-20 bg-gradient-to-br from-primary-light to-white relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full">
          ...
          <div
            className="absolute top-32 right-20 w-32 h-32 bg-primary/8 rounded-full blur-2xl animate-float"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute bottom-20 left-1/4 w-48 h-48 bg-primary/3 rounded-full blur-3xl animate-float"
            style={{ animationDelay: "3s" }}
          ></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-muted-foreground text-xl max-w-3xl mx-auto leading-relaxed">
              We're not just another AI directory. We're your comprehensive AI
              companion with premium features and expert curation.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Every tool is hand-picked and tested by AI experts to ensure quality and relevance.",
                features: [
                  "Quality Verified",
                  "Expert Reviews",
                  "Regular Updates",
              ...
              },
              {
                ...
                title: "Latest Trends",
                description:
                  "Stay ahead with real-time AI news, trending tools, and emerging technologies.",
                features: [
                  "Daily Updates",
                  "Trend Analysis",
                  "Industry Insights",
              ...
              },
              {
                ...
                description:
                  "Join a thriving community of AI enthusiasts sharing knowledge and experiences.",
                features: ["User Reviews", "Community Forums", "Networking"],
              },
            ].map((feature, index) => (
              <Card
                key={index}
                className="group hover:border-primary hover:scale-105 transition-all duration-500 animate-slide-up text-center overflow-hidden"
                style={{ animationDelay: `${index * 0.15}s` }}
              >
                <CardContent className="p-8">
                  <div className="mb-6">
          ...
          <div className="text-center">
            <Button
              ...
              size="lg"
              className="group primary-gradient text-white text-lg px-12 py-6 shadow-xl hover:scale-105 transition-all duration-300 overflow-hidden"
            >
              <div className="absolute inset-0 bg-white/20 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700 skew-x-12"></div>
              <Sparkles className="mr-3 h-6 w-6 group-hover:rotate-12 transition-transform duration-300 relative z-10" />
              <span className="relative z-10">
                Start Exploring Premium AI Tools
              </span>
            </Button>
            <p className="text-muted-foreground mt-4">
              Join 50K+ professionals who trust our platform
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-br from-white to-primary-light relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-12 animate-slide-up">
              Trusted by AI Enthusiasts Worldwide
            </h2>

            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="animate-scale-bounce">
                <div className="text-3xl md:text-4xl font-bold primary-gradient bg-clip-text text-transparent">
                  100+
                </div>
